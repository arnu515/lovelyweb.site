<script lang="ts">
  import { Check, X, Calendar, ExternalLink, Mail } from 'lucide-svelte';
  ...
  <div class="text-center">
    ...
    >
      ...
      <p class="mb-6 text-gray-600 dark:text-gray-300">
        You don't have any pending organisation invites. Create your own
        organisation to get started with your team.
      </p>
    </div>
  </div>
{:else}
        ...
        >
          ...
          >
            ...
            <div class="flex-1 space-y-4">
              ...
              <!-- Invited By -->
              <div
                class="flex flex-col gap-3 rounded-lg bg-gray-100 p-3 dark:bg-gray-800/50"
              >
