  ...
  let emails: Email[] = [
    {
      ...
      preview:
        "Hi team, I've scheduled our Q4 budget review for next Tuesday. Please review the attached documents...",
      time: '2 min ago',
      isRead: false,
      isImportant: true,
      isSelected: false,
    ...
    },
    {
      ...
      preview:
        "The development phase is progressing well. We're on track to meet the deadline. Here's the latest status...",
      time: '1 hour ago',
      isRead: false,
      isImportant: false,
      isSelected: false,
      attachments: [{ name: 'status-report.pdf', size: '856 KB', type: 'pdf' }],
    ...
    },
    {
      ...
      preview:
        "I've updated our design system with new components and guidelines. Please review and provide feedback...",
      time: '3 hours ago',
      isRead: true,
      isImportant: true,
      isSelected: false,
    ...
    },
    {
      ...
      preview:
        "Here are the notes from this week's standup meeting. Key highlights and action items are included...",
      time: 'Yesterday',
      isRead: true,
      isImportant: false,
      isSelected: false,
      attachments: [{ name: 'standup-notes.docx', size: '245 KB', type: 'word' }],
      tags: ['meeting', 'team'],
      avatar:
    ...
    },
    {
      ...
      preview:
        "The Q3 marketing campaign has concluded with excellent results. Here's a detailed breakdown of the metrics...",
      time: '2 days ago',
      isRead: true,
      isImportant: false,
      isSelected: false,
...
<div class="flex h-full flex-col">
  ...
  <div
    class="glass dark:glass-dark hidden border-t border-white/20 p-2 dark:border-gray-700/50 md:block"
  >
    <div
      class="flex items-center justify-center space-x-2 overflow-x-auto text-xs text-gray-500 dark:text-gray-400 md:space-x-4"
    >
      <span
        ><kbd class="rounded bg-gray-200 px-1 dark:bg-gray-700">j/k</kbd> navigate</span
      >
      <span
        ><kbd class="rounded bg-gray-200 px-1 dark:bg-gray-700">x</kbd> select</span
      >
      <span
        ><kbd class="rounded bg-gray-200 px-1 dark:bg-gray-700">Enter</kbd> open</span
      >
      <span
        ><kbd class="rounded bg-gray-200 px-1 dark:bg-gray-700">s</kbd> star</span
      >
      <span
        ><kbd class="rounded bg-gray-200 px-1 dark:bg-gray-700">r</kbd> read</span
      >
      <span
        ><kbd class="rounded bg-gray-200 px-1 dark:bg-gray-700">d</kbd> delete</span
      >
      <span
        ><kbd class="rounded bg-gray-200 px-1 dark:bg-gray-700">/</kbd> search</span
      >
    </div>
  </div>
</div>
