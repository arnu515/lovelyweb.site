  ...
  <div class="mx-auto max-w-2xl">
    <div class="relative">
      ...
      <Input
        ...
        class="glass dark:glass-dark w-full rounded-2xl border-white/20 py-4 pl-12 pr-4 text-lg shadow-lg transition-all duration-200 focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/50 dark:border-gray-700/50"
      />
    </div>
  </div>
